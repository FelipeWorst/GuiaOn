...
while (opcao) {
    ...
    switch (escolha) {
        case "1":
            console.log(backendPasseio.mostrarDados());
            menu()
            break;
        ...
        case "2":
            ...
            console.log(backendPasseio.inserirPasseio(dataPasseio, dataVolta, pago));
        ...
        case "3":
            ...
            console.log(backendPasseio.deletarPasseio(dataPasseioParaDeletar));
            menu()
            break;
